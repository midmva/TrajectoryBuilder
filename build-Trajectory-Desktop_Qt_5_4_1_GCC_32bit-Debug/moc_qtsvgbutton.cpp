...
#include "../../../../../opt/embedded-widgets-1.1.0/src/svgbutton/qtsvgbutton.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtSvgButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 37, 10), // "nonhovered"
QT_MOC_LITERAL(6, 48, 7), // "pressed"
QT_MOC_LITERAL(7, 56, 4) // "skin"

    },
    "QtSvgButton\0hovered\0\0QWidget*\0parent\0"
    "nonhovered\0pressed\0skin"
};
...
void QtSvgButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->hovered((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 1: _t->nonhovered((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 2: _t->pressed((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (QtSvgButton::*_t)(QWidget * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtSvgButton::hovered)) {
                *result = 0;
            }
        }
        {
            typedef void (QtSvgButton::*_t)(QWidget * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtSvgButton::nonhovered)) {
                *result = 1;
            }
        }
        {
            typedef void (QtSvgButton::*_t)(QWidget * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtSvgButton::pressed)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject QtSvgButton::staticMetaObject = {
    { &QAbstractButton::staticMetaObject, qt_meta_stringdata_QtSvgButton.data,
      qt_meta_data_QtSvgButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void QtSvgButton::hovered(QWidget * _t1)
{
...
// SIGNAL 1
void QtSvgButton::nonhovered(QWidget * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void QtSvgButton::pressed(QWidget * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
