...
void Change::pressButton1(){
    emit pressButton(1);
}

void Change::pressButton2(){
    emit pressButton(2);
}

void Change::pressButton3(){
    emit pressButton(3);
}

void Change::pressButton4(){
    emit pressButton(4);
}

void Change::pressButton5(){
    emit pressButton(5);
}

void Change::pressButton6(){
    emit pressButton(6);
}

void Change::pressButton7(){
    emit pressButton(7);
}
